      ...
      <div class="three wide column">
        <div class="ui segment">
          <div class="ui middle aligned divided list">
            ...
            <div style="padding:1em;" class="item">
              <!--<div class="content"></div><router-link to="/administrator/moderation" class="grey-text"><i class="talk outline icon"></i>Moderation</router-link>-->
              <div class="content"><router-link to="/jury/translate" class="primarytext"><i class="write icon"></i>Translate</router-link></div>
            </div>
          </div>
        </div>
      </div>
...
<script>
    ...
    import KontenUtama from './KontenTranslate';
